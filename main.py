...
class MyServer(BaseHTTPRequestHandler):
                ...
                <main class="container">
                    <div class="row text-center">
                        ...
                        <div class="col-4">
                            ...
                            <form class="card mb-4 rounded-3 shadow-sm">
                                <div class="card-body">
                                    <div class="mb-3">
                            ...
                            <div class="accordion" id="faqAccordion">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body">
                                            Ответ на вопрос "Как купить?" Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                         data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Ответ на вопрос "Как доставить?" Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                         data-bs-parent="#faqAccordion">
                                        <div class="accordion-body">
                                            Ответ на вопрос "Какая гарантия?" Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit.
                                        </div>
                                    </div>
    ...
    def do_GET(self):
        ...
        page_content = self.get_html_content(self)
